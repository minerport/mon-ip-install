...
CONFIG_FILE='bitcoinmonster.conf'
CONFIGFOLDER='/root/.bitcoinmonstercore'
CONFIGFOLDER2='/root/.bitcoinmonstercore2'
CONFIGFOLDER3='/root/.bitcoinmonstercore3'
COIN_DAEMON='/root/mon-ip-install/BTCmonster/bitcoinmonsterd'
COIN_CLI='/root/mon-ip-install/BTCmonster/bitcoinmonster-cli'
